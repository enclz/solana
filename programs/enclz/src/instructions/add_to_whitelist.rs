...
pub fn handle_add_to_whitelist(
    ...
    let (stored_ttl, stored_amount) = match entry_type_arg {
        entry_type::INTRA_GROUP => return err!(EnclzError::Unauthorized),
        entry_type::EXTERNAL => {
    ...
    whitelist_entry.entry_type = entry_type_arg;
